      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12">
          ...
          <p class="text-gray-300 text-lg max-w-2xl">
            G�rez efficacement vos travailleurs, ESATs et utilisateurs depuis cette interface centralis�e.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-12">
          ...
          <div class="relative bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-200 group">
            ...
            <div class="mb-4">
              ...
              <p class="text-gray-400 text-sm">Travailleurs actifs dans le syst�me</p>
            </div>
          ...
          <div class="relative bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-200 group">
            ...
            <div class="mb-4">
              ...
              <p class="text-gray-400 text-sm">�tablissements partenaires</p>
            </div>
          ...
          <div class="relative bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-200 group">
            ...
            <div class="mb-4">
              ...
              <p class="text-gray-400 text-sm">Utilisateurs du syst�me</p>
            </div>
          ...
          <div class="relative bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-200 group">
            <div class="flex items-center justify-between mb-4">
              ...
              <div class="text-right">
                ...
                <div class="text-sm text-yellow-400 font-medium">{{ pendingReviewCount }} � r�viser</div>
              </div>
            </div>
            <div class="mb-4">
              <h3 class="text-lg font-semibold text-white mb-1">Suggestions IA</h3>
              <p class="text-gray-400 text-sm">Recommandations g�n�r�es</p>
            </div>
        ...
        <div v-if="showAiSuggestions" class="mt-8">
          <div class="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8">
            <div class="flex items-center justify-between mb-6">
              <h2 class="text-xl font-semibold text-white">Suggestions IA r�centes</h2>
              <div class="flex items-center space-x-3">
                <select v-model="selectedStatus" @change="loadAiSuggestions" class="bg-white/10 border border-white/20 text-white rounded-lg px-3 py-2 text-sm">
                  ...
                  <option value="reviewed">R�vis�</option>
                  <option value="applied">Appliqu�</option>
                ...
                <select v-model="selectedType" @change="loadAiSuggestions" class="bg-white/10 border border-white/20 text-white rounded-lg px-3 py-2 text-sm">
                  ...
                  <option value="skills_assessment">�valuation comp�tences</option>
            ...
            <div v-else-if="aiSuggestions.length === 0" class="text-center py-8">
              ...
              <h4 class="text-lg font-semibold text-white mb-2">Aucune suggestion trouv�e</h4>
              <p class="text-gray-400">Il n'y a pas encore de suggestions d'IA g�n�r�es</p>
            </div>
              ...
              <div v-for="suggestion in aiSuggestions" :key="suggestion.id" class="bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-all duration-200">
                ...
                <div v-if="isSuggestionExpanded(suggestion.id)" class="px-4 pb-4 border-t border-white/10">
                  <div class="pt-4 space-y-4">
                    <!-- Prompt -->
                    <div>
                      <h5 class="text-sm font-semibold text-gray-300 mb-2">Question pos�e :</h5>
                    ...
                    <!-- R�ponse compl�te -->
                    <div>
                      <h5 class="text-sm font-semibold text-gray-300 mb-2">R�ponse de l'IA :</h5>
                    ...
                    <div class="grid grid-cols-2 gap-4 pt-2 border-t border-white/10">
                      <div>
                        <p class="text-xs text-gray-400">Date de cr�ation</p>
                        <p class="text-sm text-gray-200">{{ formatDate(suggestion.created_at) }}</p>
                      </div>
                      <div v-if="suggestion.reviewed_at">
                        <p class="text-xs text-gray-400">Date de r�vision</p>
...
const expandedSuggestions = ref(new Set()) // Pour g�rer les d�tails d�roulants
...
onMounted(async () => {
  try {
    ...
    // Charger le nombre de suggestions IA en attente de r�vision
...
// Fonctions pour formater les donn�es
...
const formatType = (type) => {
  const typeMap = {
    ...
    'skills_assessment': '�valuation comp�tences',
...
// Fonction pour mettre � jour le statut d'une suggestion
const updateSuggestionStatus = async (id, newStatus) => {
  try {
    ...
    if (response.ok) {
      // Recharger les suggestions pour refl�ter le changement
...
// Fonction pour basculer l'affichage des d�tails d'une suggestion
...
// V�rifier si une suggestion est d�pli�e
...
const loadMoreAiSuggestions = async () => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      // Ajouter les nouvelles suggestions � la liste existante
