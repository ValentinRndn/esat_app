  ...
  <div class="w-full">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start mb-6">
      ...
      <div class="flex space-x-2">
        <NuxtLink v-if="esat" :to="`/esats/edit/${esat.id}`" class="inline-flex items-center px-4 py-2 bg-pink-600 text-white rounded-lg shadow-sm hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition-colors duration-200">
