            ...
            <tr v-for="esat in esats" :key="esat.id" class="hover:bg-pink-50 transition-colors duration-150">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                <div class="flex items-center justify-center space-x-2">
                  ...
                  <NuxtLink :to="`/esats/edit/${esat.id}`" class="p-1.5 rounded-full hover:bg-green-50 text-green-500 hover:text-green-600 transition-colors duration-200" title="Modifier">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
