      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-if="success" class="bg-green-500/10 backdrop-blur-lg border border-green-500/20 rounded-2xl p-6 mb-8">
          <div class="flex items-start">
            ...
            <div class="flex-1">
              <span class="text-green-300">Travailleur créé avec succès !</span>
              ...
              <div class="bg-white/5 rounded-lg p-6 border border-white/10">
                ...
                <div class="space-y-4">
                  <div class="border-2 border-dashed border-white/20 rounded-lg p-8 text-center hover:border-purple-400/50 transition-colors duration-200">
                    ...
                    <div v-if="pdfSuccess" class="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                      <div class="flex items-start">
                        <svg class="h-5 w-5 text-green-400 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span class="text-green-300 text-sm">{{ pdfSuccess }}</span>
                      </div>
                    </div>
                  </div>
                </div>
